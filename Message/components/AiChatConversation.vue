<template>
  <div class="flex flex-col h-full">
    ...
    <div v-if="!audioRecorder.is_recording" class="px-4 py-3 flex-shrink-0 relative">
      ...
      <a href="https://github.com/haideralise" target="_blank" rel="noopener noreferrer" class="text-center text-[11px] text-gray-400 mt-2.5 flex items-center justify-center gap-1 hover:text-gray-500 transition-colors no-underline">
